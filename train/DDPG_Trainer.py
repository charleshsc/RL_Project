...
def DDPG_Trainer(logger, saver, cfg_dict, checkpoint):
    ...
    model = DDPG(state_dimention, action_dimention, max_action_value, discount, tau, lr)
    ...
    for t in range(int(max_timesteps)):
        ...
        if t < start_timesteps:
            ...
            action = model.select_action(np.array(state)).clip(-max_action_value, max_action_value)
